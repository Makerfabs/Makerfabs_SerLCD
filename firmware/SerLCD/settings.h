...
const byte DEFAULT_BAUD = BAUD_9600;  //115200 for 8MHz, 2x speed
const byte DEFAULT_RED = 1;
const byte DEFAULT_GREEN = 1;
const byte DEFAULT_BLUE = 1;
const byte DEFAULT_LINES = 2;
const byte DEFAULT_WIDTH = 16;
const byte DEFAULT_SPLASH = true; //Default on

const byte DEFAULT_CONTRAST_LCD = 120;
